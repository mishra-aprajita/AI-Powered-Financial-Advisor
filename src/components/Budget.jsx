...
export default function Budget({ expenses, budgets, setBudgets, darkMode, currency = 'INR' }) {
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-4xl font-extrabold text-white">
              {fmt(totalSpent, currency)} <span className="text-2xl text-indigo-200">/ {fmt(totalBudget, currency)}</span>
            </p>
            <p className="text-indigo-200 text-sm mt-1">{overallPct}% of total budget used</p>
          </div>
          <div className="flex gap-6">
            <div className="text-center">
              <p className="text-2xl font-bold text-white">{fmt((totalBudget - totalSpent), currency)}</p>
            ...
            <div key={cat} className="card p-5 fade-in hover:scale-[1.01]"
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm">
                  <span className="font-bold" style={{ color: textMain }}>{fmt(catSpent, currency)}</span>
