...
export default function App() {
  ...
  const renderSection = () => {
    switch (active) {
      case 'dashboard': return <Dashboard expenses={expenses} profile={profile} darkMode={darkMode} />;
      case 'expenses':  return <Expenses expenses={expenses} setExpenses={setExpenses} darkMode={darkMode} />;
      case 'budget':    return <Budget expenses={expenses} budgets={budgets} setBudgets={setBudgets} darkMode={darkMode} />;
      case 'analytics': return <Analytics expenses={expenses} budgets={budgets} darkMode={darkMode} />;
      case 'advisor':   return <Advisor expenses={expenses} profile={profile} darkMode={darkMode} />;
      default: return null;
    }
  };
